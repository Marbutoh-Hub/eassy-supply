...
<head>
	...
	<title>Long Pants | Chemistry Store</title>
		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle">Product Long Pants</h1>
					</div>
					<div class="row">
						<div class="col">
							<div class="card">
								<div class="card-header mb-4">
									<h5 class="card-title">Data Product Long Pants</h5>
								</div>
								<div class="card-header mb-4 ">
									<button class="btn btn-primary" type="submit">Tambah Data Barang</button>
								</div>
								<div class="card-body mt-4">
									<table class="table table-bordered border-primary" id="longpants">
										<thead>
											<tr>
												<th>no</th>
												<th>Picture</th>
